...
<template>
  <div class="csp-wrapper">
    <div class="csp-container">
      ...
      <p class="csp-intro">
        These terms govern your use of JozyChat, a personal diary and
      ...
      <section class="csp-section">
        ...
        <p>
          By accessing or using JozyChat, you agree to this User Agreement and
          our Privacy Policy. If you do not agree, you should not use JozyChat.
      ...
      <section class="csp-section">
        <h2>2. What JozyChat provides</h2>
        <p>
          JozyChat lets you create diary entries with text, images, or short
        ...
        <p>
          JozyChat is designed for personal diary writing, everyday
      ...
      <section class="csp-section">
        ...
        <ul>
          ...
          <li>
            You must be old enough to use JozyChat under applicable law and
      ...
      <section class="csp-section">
        ...
        <p>
          ...
          to JozyChat. You should only upload or share content that you have
      ...
      <section class="csp-section">
        ...
        <ul>
          <li>Using JozyChat for fraud, illegal activity, harassment, abuse, or impersonation.</li>
          ...
          <li>Interfering with JozyChat's security, availability, or normal operation.</li>
          <li>
            Presenting JozyChat content as medical advice, therapy, diagnosis,
      ...
      <section class="csp-section">
        ...
        <p>
          JozyChat has zero tolerance for child sexual abuse and exploitation
      ...
      <section class="csp-section">
        ...
        <p>
          JozyChat may include personal feelings, moods, habits, and everyday
          emotional snapshots shared by users. This content is for personal
          expression and community connection only. JozyChat does not provide
      ...
      <section class="csp-section">
        ...
        <p>
          ...
          to time. We try to keep JozyChat available, but we do not guarantee
      ...
      <section class="csp-section">
        ...
        <p>
          ...
          other action needed to protect JozyChat, users, or the public.
      ...
      <section class="csp-section">
        ...
        <p>
          JozyChat is provided on an "as is" and "as available" basis. Diary
      ...
      <section class="csp-section">
        ...
        <p>
          ...
          as required by applicable law. Continued use of JozyChat after an
