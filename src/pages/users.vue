  ...
  <div class="csp-wrapper">
    <div class="csp-container">
      <header class="csp-header">
        <h1>Voxtalk Policy Agreement</h1>
        <p class="csp-updated">Last updated: June 23, 2026</p>
      </header>

      <p class="csp-intro">
        Voxtalk adheres to a zero-tolerance policy for any form of child
        ...
        violate the Voxtalk Policy will have their accounts
      ...
      <section class="csp-section">
        ...
        <ul>
          <li>Users must be at least 18 years old to use Voxtalk.</li>
          <li>
      ...
      <section class="csp-section">
        ...
        <p>
          Voxtalk uses both automated and manual systems to detect underage
      ...
      <section class="csp-section">
        ...
        <p>
          ...
          trafficking) are strictly prohibited from using Voxtalk.
        </p>
      </section>
      ...
      <section class="csp-section">
        ...
        <p>
          Voxtalk will strictly enforce the Child Safety Policy, and any
          violations will result in immediate penalties. Depending on the
          severity of the violation, Voxtalk may cooperate with law
      ...
      <section class="csp-section">
        ...
        <p>Voxtalk educates users about child safety through the following methods:</p>
        <ul>
      ...
      <section class="csp-section">
        ...
        <p>
          If you encounter child exploitation or abuse outside of Voxtalk, we
      ...
      <section class="csp-section">
        ...
        <p>
          Voxtalk is committed to continuously evaluating and improving its
