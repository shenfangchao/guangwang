...
<template>
  <div class="pp-container">
    <header class="pp-header">
      <h1>Mageo Privacy Policy</h1>
      <p class="pp-updated">
        Date of the latest edition: July 24, 2026
      </p>
    </header>

    <p class="pp-intro">
      Mageo is a personal diary and mood-sharing community for everyday
      ...
      you have when using Mageo.
    </p>

    <section class="pp-section">
      <h2>1. Information we collect</h2>
      <p>
        The information we collect depends on how you use Mageo and what
      ...
      <p>
        Mageo may process diary entries you create, including text,
      ...
      <p>
        If you allow device permissions, Mageo may access your camera,
      ...
      <p>
        ...
        secure, debug, and improve Mageo.
      </p>
    </section>
    ...
    <section class="pp-section">
      ...
      <ul>
        ...
        <li>To protect Mageo, moderate content, prevent misuse, and enforce our terms.</li>
    ...
    <section class="pp-section">
      ...
      <p>
        ...
        process information only as needed to support Mageo.
      </p>
      ...
      <p>
        ...
        enforce our terms, or protect our rights. If Mageo is involved in a
    ...
    <section class="pp-section">
      ...
      <p>
        We keep information for as long as needed to provide Mageo, maintain
    ...
    <section class="pp-section">
      ...
      <p>
        Mageo is intended for users who are old enough to use diary and
        ...
        to Mageo, please contact us so we can review and take appropriate
        action.
      </p>
    </section>
    ...
    <section class="pp-section">
      ...
      <address class="pp-address">
        Contact email:
        <a href="mailto:xiechengfang1977@icloud.com?subject=Privacy%20Policy%20question">
